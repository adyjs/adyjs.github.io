...
Exchange.prototype = Object.create(Sort_obj.prototype);
Exchange.prototype.constructor = Exchange;

Exchange.prototype.count_err_validate = function(){
...
Exchange.prototype.generate_shuffle_square = function(){
...
Exchange.prototype.sorting = function(){
...
Exchange.prototype.animate_func = function(){
	document.getElementById("stage").innerHTML = "";
